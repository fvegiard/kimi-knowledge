...
lang: zh
fetched: 2026-09-16
html_sha256: 74d69d3af001bc4c52595d4b19f96dcdd388f8fceb38e86bf485dd046156154f
---

[帮助中心](/help) › [Kimi Code](/help/kimi-code) › [开始使用](/help/kimi-code/cli-getting-started)
...
![验证安装](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-code/images/cli-getting-started/cli-getting-started-02.2ca4734f8483.png)
...
想看完整列表，输入 `/help` 或访问[工作模式](/help/kimi-code/cli-work-modes)和[交互与输入](/help/kimi-code/cli-interaction)。
...
更多问题请参考[常见问题](/help/kimi-code/faq)。

## 下一步

- [交互与输入](/help/kimi-code/cli-interaction) — 输入框操作、审批流程、Plan 模式和 YOLO 模式详解
- [会话与上下文](/help/kimi-code/cli-sessions) — 恢复会话、上下文压缩、导出会话
- [常见使用案例](/help/kimi-code/cli-use-cases) — 典型任务的 prompt 示例

本文是否对你有帮助



[ › 上一篇联系与反馈](/help/kimi-code/contact-and-feedback)[下一篇 › 交互与输入](/help/kimi-code/cli-interaction)
