...
source: https://www.kimi.com/help/kimi-code/faq
lang: zh
fetched: 2026-09-16
html_sha256: 4c933cd5eaa83a297a01e4086dafae922e3d94ad420d95bbb501fd7c2bb38cbd
---

[帮助中心](/help) › [Kimi Code](/help/kimi-code) › [Kimi Code 常见问题](/help/kimi-code/faq)
...
|-------------------|------------------------------------------------|-------------------------|-------------------------------------------------|
| **Kimi Code**     | Anthropic 兼容：`https://api.kimi.com/coding/` | Kimi 会员订阅（含额度） | [Kimi Code 控制台](/code/console)               |
...
如果你使用 Kimi Code 平台，可以通过 `/usage` 命令查看当前的配额和会员状态。如果配额用尽或会员过期，需要在 [Kimi Code](/code) 续费或升级。

## 订阅相关

### 如何开发票或升级会员

请前往 [Kimi 会员权益页面](/membership/pricing#pricing-faq)，根据页面指引完成开票申请或会员升级操作。
...
如果以上内容未能解决你的问题，欢迎通过邮件联系我们：[\[email protected\]](/cdn-cgi/l/email-protection#24474b404164494b4b4a574c4b500a454d)。请在邮件中描述你遇到的问题、操作步骤及相关日志信息，我们会尽快回复。

本文是否对你有帮助



[ › 上一篇权益说明](/help/kimi-code/benefits)[下一篇 › 联系与反馈](/help/kimi-code/contact-and-feedback)
