...
source: https://www.kimi.com/help/agent/agent-swarm
lang: zh
fetched: 2026-09-16
html_sha256: 42cfa8f1fcf3f36da64d1821b35fe6c6542bfbc7915aa4530880a4cbb2c2fe4d
---

[帮助中心](/help) › [Agent模式](/help/agent) › [Agent 集群（Agent Swarm）](/help/agent/agent-swarm)
...
![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-01.9f26f463aaf3.png)
...
![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-02.277ab84c390c.png)

- 网页版：[https://www.kimi.com/agent-swarm](/agent-swarm)
...
![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-03-01.487802b8c338.png)
...
![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-04.1f89e14ba528.png)
...
案例1：100个细分领域Top 3创作者挖掘 任务要求找出100个YouTube细分领域各自的Top 3创作者。Agent Swarm 首先研究并定义每个领域，然后自主创建300个子智能体进行并行搜索，最终生成包含频道名称、订阅数、描述的结构化表格和可视化图表。

![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-04.1f89e14ba528.png)

任务执行结果：100 位子智能体（sub-agent）正在寻找创作者

[查看结果](/share/19c40eea-b272-8ef2-8000-0000af5e0baa?hide_sidebar=1&disable_auto_preview=1)

案例2：收集200+篇Paul Graham 文章 Paul Graham 的文章分散在个人网站、旧博客、转录演讲中。Agent Swarm指派专门的子智能体搜索、下载、分类、总结，最终将超过200篇原始文章整理进主题文件夹，并生成综合总结报告。

![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-05.d91606802fd4.png)

任务执行结果：收集200+篇Paul Graham 文章

[查看结果](/share/19cc436e-73c2-89bd-8000-000078b7d71e?hide_sidebar=1&disable_auto_preview=1)

### 规模化输出

案例：从40篇PDF生成100页文献综述 Agent Swarm 将任务分解到文档集合，部署多个写作专用子智能体，每个负责特定章节。最终输出一份100页、双栏的学术文档，包含完整格式化的引用和参考文献，以及方法分布饼图、引用网络分析图等可视化内容。

![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-06.69dd6865a464.png)

任务执行结果：Generate 100-Page Literature Review from 40 PDFs

[查看结果](/share/19c4106b-89b2-8361-8000-0000d07b8235?hide_sidebar=1&disable_auto_preview=1)
...
![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-07.df818b764ab9.png)

任务执行结果：Get your product plan reviewed by a team of experts

[查看结果](/share/19c40bc9-31a2-8533-8000-0000bad59b7a?hide_sidebar=1&disable_auto_preview=1)

案例：《三体》20种文学风格续写 Agent Swarm创建了20位不同文学风格的"作家"子智能体——从弗吉尼亚·伍尔夫式的内心独白，到博尔赫斯式的思想迷宫，再到卡夫卡式的荒诞世界。每位"作家"独立创作，最终呈现出同一故事内核的多元叙事可能。

![image](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/swarm/swarm-08.fe530d44ba8e.png)

任务执行结果：Let 20 writers create alternative endings for The Three-Body Problem

[查看结果](/share/19c409c8-8692-821a-8000-0000070ad369?hide_sidebar=1&disable_auto_preview=1)
...
1.  Kimi官方博客 - "Kimi Agent Swarm: 100 Sub-Agents at Scale" ([https://www.kimi.com/blog/agent-swarm](/blog/agent-swarm))
2.  Kimi K2.5技术博客 - "Kimi K2.5: Visual Agentic Intelligence" ([https://www.kimi.com/blog/kimi-k2-5](/blog/kimi-k2-5))
3.  Kimi K2.6技术博客 - "Kimi K2.6: Advancing Open-Source Coding" ([https://www.kimi.com/blog/kimi-k2-6](/blog/kimi-k2-6))
4.  Kimi K3技术博客 - "Kimi K3" ([https://www.kimi.com/blog/kimi-k3](/blog/kimi-k3))

本文是否对你有帮助



[ › 上一篇Kimi Agent 概述](/help/agent/agent-overview)[下一篇 › Agent 功能与限制](/help/agent/agent-features-and-limits)
