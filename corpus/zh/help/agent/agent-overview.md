...
lang: zh
fetched: 2026-09-16
html_sha256: 8ca9a22381f3bad37e8e4f11a34faa0bf4f19aa8fc81859942926d9f89a7f6cc
---

[帮助中心](/help) › [Agent模式](/help/agent) › [Kimi Agent 概述](/help/agent/agent-overview)
...
![Agent产品入口](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/agent-overview/overview-00.67c2d3b1d1af.png)
...
![Agent产品入口](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/agent-overview/overview-01.1d1858c55708.png)

- 网页版：[https://www.kimi.com/agent](/agent)
...
![Agent用户任务输入](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/agent-overview/overview-02.f25a220deb20.png)
...
![Agent任务过程](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/agent-overview/overview-03.4569ad5d7efe.png)

3.  任务完成后，获取专业级别的交付成果
4.  根据任务类型，Agent 会生成相应的输出：

![Agent产出物示意](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/agent-overview/overview-04.106906367c62.png)
...
![Agent适用场景](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/agent/images/agent-overview/overview-06.0159d4766b3c.png)
...
[](/help/websites/websites-overview)


### 网站生成

零代码基础，也可以做出一个多功能的网站原型并部署上线。
...
智能文档编辑、数据分析，支持 Word、Excel、PDF 等多种格式。
...
通过复杂搜索、多步推理，生成万字高质量研究报告。

本文是否对你有帮助



[ › 上一篇定时任务（Scheduled Tasks）](/help/features/scheduled-tasks)[下一篇 › Agent 集群（Agent Swarm）](/help/agent/agent-swarm)
