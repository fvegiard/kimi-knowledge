...
source: https://www.kimi.com/help/plugins-and-skills/overview
lang: zh
fetched: 2026-09-16
html_sha256: e1bc5c74425d7adcfa6f31c6edc9094f1d27a707799332324aaf881ad190fbe6
---

[帮助中心](/help) › [插件和技能](/help/plugins-and-skills) › [插件是什么](/help/plugins-and-skills/overview)
...
在 **Kimi Work 桌面端**也可以使用插件；桌面端内置的插件清单见 [Kimi Work 插件中心](/help/kimi-work/plugin-center)。
...
可以。你可以参考[如何创建个人插件](/help/plugins-and-skills/create)，将其他平台的已有插件文件或项目链接提供给 Plugin Builder，按照引导将其转换为 Kimi 插件。

本文是否对你有帮助



[ › 上一篇发布日志](/help/kimi-work/release-notes)[下一篇 › 如何创建个人插件](/help/plugins-and-skills/create)
