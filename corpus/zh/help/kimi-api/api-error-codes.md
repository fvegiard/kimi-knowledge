...
source: https://www.kimi.com/help/kimi-api/api-error-codes
lang: zh
fetched: 2026-09-16
html_sha256: 38ec77ef17dd4c029822591b458a704e6bf9a7942634e0937ac5b070a7ec1d6f
---

[帮助中心](/help) › [Kimi API与企业合作](/help/kimi-api) › [调用 API 报错（错误码说明）](/help/kimi-api/api-error-codes)
...
- **收到 500**：请稍后重试，如持续出现请附带 `request_id` 联系支持团队 [\[email protected\]](/cdn-cgi/l/email-protection#b1d0c1d89cc2d4c3c7d8d2d4f1dcdededfc2d9dec59fd0d8)。

本文是否对你有帮助



[ › 上一篇Kimi API 介绍](/help/kimi-api/api-overview)[下一篇 › API 计费说明](/help/kimi-api/api-pricing)
