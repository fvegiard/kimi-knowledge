...
source: https://www.kimi.com/help/kimi-claw/android-user-guide
lang: zh
fetched: 2026-09-16
html_sha256: b970359c622118de2bb78b6469303f0b243e1f79819fac7cdb81730694a49c4f
---

[帮助中心](/help) › [Kimi Claw](/help/kimi-claw) › [Kimi Claw Android 产品介绍](/help/kimi-claw/android-user-guide)
...
![Kimi Claw Android Dashboard 主界面](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-01.efaef2433ffd.png)
...
![Kimi 网页端下载入口](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-02.d2e9c20973a4.png)

**方式二：手机应用商店直接下载**

在手机应用商店搜索"Kimi Claw"，完成下载。

![应用商店搜索下载](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-04.81bbf8e1f8b7.png)

**方式三：手机 Kimi App 下载**

打开 Kimi App，点击 Kimi Claw Android 完成下载。

![Kimi App 下载入口](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-05.eac71de99918.png)
...
![权限设置详情](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-08.cdf069aef22b.png)

#### Step 2：配置 Kimi 账号

点击「去配置」，跳转至 Kimi App 进行授权。授权后，Kimi 将自动创建一个 Kimi Coding Plan API Key 用于 Kimi Claw Android。

![配置 Kimi 账号](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-09.6b2427b4aa9b.png)

如果你是未订阅用户，需要先开通会员权益，点击「升级订阅」进行会员开通。Kimi Claw Android 需要 Allegretto 等级才可激活。

#### Step 3：安装 OpenClaw

![安装 OpenClaw](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-13.a50764b3f553.png)
...
![Dashboard 启动完成状态](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-16.86f2a37c3e31.png)
...
![聊天渠道管理](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-17.f307421f5e5c.png)
...
![实时日志页面](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-19.2b7015345742.png)
...
![设置页面](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-20.a11dcbb671c3.png)

#### SkillHub Skills

打开后自动跳转 SkillHub，可一键下载 Skill 到 Kimi Claw Android。下拉选择自己要下载的 Skill，进入页面，点击安装，即可完成 Skill 的导入。

![SkillHub Skills 列表](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-21.c4bb1e434d1c.png)

![Skill 安装页面](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-23.42323db742b3.png)

#### OpenClaw 工作空间

打开后进入本机 OpenClaw 的运行目录，可在此定义个人 AGENTS.md、HEARTBEAT.md、IDENTITY.md 等。

![OpenClaw 工作空间](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-25.dce966c0f5ae.png)
...
![备份与恢复页面](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-26.7c8ff219ee7f.png)
...
![备份恢复页面](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-28.8cf47529371c.png)
...
![Kimi Bot 管理](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-31.9aafb83c577c.png)

![Kimi Claw Android 在 Bot 列表中](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-32.67d26e5dc572.png)
...
![飞书扫码创建](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-33.1c5db06ac692.png)

#### 打开飞书创建

点击「打开飞书创建」，按提示在飞书中完成应用创建，状态自动更新为「已连接」。

![打开飞书创建](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-34.6ece26ba335b.png)
...
![手动输入 Bot 信息](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-37.c3ac5e19f2a8.png)

#### 删除飞书渠道

点击已连接的飞书渠道，选择删除。删除后将不再通过该飞书机器人与 OpenClaw 通信。

![删除飞书渠道](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-38.c4ec721f68da.png)
...
![微信 Claw 安装 2](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-39.6971013b7668.png)

进入 Kimi Claw Android，连接微信渠道，用微信扫码完成。

![微信扫码等待连接](https://statics.kimi.ai/kimi-helpcenter-doc/zh-CN/kimi-claw/images/android-user-guide/screenshot-43.41168ce57440.png)
...
[ › 上一篇Kimi Claw 群聊](/help/kimi-claw/kimiclaw-group-chat)[下一篇 › 一键部署 Kimi Claw Desktop](/help/kimi-claw/desktop-deployment-guide)
