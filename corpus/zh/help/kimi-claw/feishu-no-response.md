...
source: https://www.kimi.com/help/kimi-claw/feishu-no-response
lang: zh
fetched: 2026-09-16
html_sha256: 2b041eb349bd13b76ea031d2b625b6ae0cfd9b392cdc8959b385e849eeb748d3
---

[帮助中心](/help) › [Kimi Claw](/help/kimi-claw) › [飞书群里 @机器人没反应？](/help/kimi-claw/feishu-no-response)
...
> 你帮我加上这几个配置： dmPolicy: pairing（私聊需要配对） groupPolicy: open（所有群都响应） requireMention: true（群里需要 @才响应）
...
请参考[配置飞书机器人](/help/kimi-claw/feishu-bot)文档，按照步骤重新配置。如果仍然无法连接，可使用[升级注意事项](/help/kimi-claw/upgrade-notice)中的飞书诊断命令进行排查。

本文是否对你有帮助



[ › 上一篇Kimi Claw 可以向我收发文件么？](/help/kimi-claw/file-transfer)[下一篇 › 如何卸载 Kimi 插件？](/help/kimi-claw/uninstall-plugin)
